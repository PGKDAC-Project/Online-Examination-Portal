...
const ManageQuestions = () => {
    ...
    const handleDraftTypeChange = (nextType) => {
        setDraft((prev) => {
            ...
            if (nextType === "numeric") {
                return { ...prev, type: nextType, options: [], correctAnswer: "" };
            }
    ...
    const saveEdit = () => {
        ...
        if (draft.type === "numeric") {
            const n = Number(draft.correctAnswer);
        ...
        const nextAll = allQuestions.map((q) => {
            ...
            return {
                ...
                type: draft.type,
                text: text,
                options: draft.type === "numeric" || draft.type === "matching" ? [] : (draft.options || []).map((o) => (o || "").trim()),
                correctAnswer: draft.type === "numeric" ? String(Number(draft.correctAnswer)) : draft.correctAnswer,
